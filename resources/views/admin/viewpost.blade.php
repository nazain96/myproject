            ...
            <tr>
              <td>
                ...
                <div class="form-group shadow-textarea">
                  ...
                  <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="3" name="comment">{{ $comments->comments }}</textarea>
            ...
            <tr>
              <th scope="row">
                ...
                <div class="form-group shadow-textarea">
                  ...
                  <form action="{{ route('admin.storeComments', $post->id) }}" method="POST">
