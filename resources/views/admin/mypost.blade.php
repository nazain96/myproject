    ...
    <td>
        ...
        <div class="card card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2814%29.jpg);">
          ...
          <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
            ...
            <a class="btn btn-raised btn-primary btn-sm" href="{{ route('admin.edit', $posts->id) }}"> Edit    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> 
                        </a>

                        ||


              <a class="btn btn-raised btn-primary btn-sm" href="{{ route('admin.viewpost', $posts->id) }}"> 
                View Post   <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>

                        ||

                        <form id="delete-form-{{ $posts->id }}" action="{{ route('admin.deletePost', $posts->id) }}" method="POST" style="display:none;">
